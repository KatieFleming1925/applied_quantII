...
## TABLE
modelsummary(list("Basic DiD" = model1, "Province FE" = model2, "Two-way FE" = model3), stars = TRUE, coef_rename = c("repression_pc" = "Repression (per 1000)", "pct_left" = "Left vote 1936", "pct_centleft" = "Centre-left vote 1936", "pct_right" = "Right vote 1936"), output = "main_models.html")
...
modelsummary(list("Basic DiD" = model4, "Province FE" = model5, "Two-way FE" = model6), stars = TRUE, coef_rename = c("repression_binary" = "Repression (binary)", "pct_left" = "Left vote 1936", "pct_centleft" = "Centre-left vote 1936", "pct_right" = "Right vote 1936"), output = "robustness_binary.html")
...
modelsummary(list("OLS" = ols_spatial, "SEM" = sem_fit, "SLM" = slm_fit), stars = TRUE, coef_rename = c("repression_pc" = "Repression (per 1000)", "pct_left" = "Left vote 1936", "pct_centleft" = "Centre-left vote 1936", "pct_right" = "Right vote 1936"), output = "spatial_models.html")
